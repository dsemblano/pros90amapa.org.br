            ...
            <div class="box bg-white p-6 rounded-lg">
                <figure class="thumbnail">
                    <a href="{{ get_permalink() }}">
                        ...
                        {{ the_post_thumbnail('post-thumbnail', ['class' => 'lg:h-60 xl:h-56 md:h-64 sm:h-72 xs:h-72 h-72
                        rounded w-full object-cover object-center mb-6', 'title' => 'Feature image']); }}
                        @else

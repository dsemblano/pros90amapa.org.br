  ...
  <div class=" box bg-white ">
    <figure class="thumbnail">
      ...
      @if ( has_post_thumbnail() )
        ...
        @else
        <img class="lg:h-60 xl:h-56 md:h-64 sm:h-72 xs:h-72 h-72   w-full object-cover object-center mb-6" alt="Imagem destacada matéria da busca" src="@asset('images/default.png')"  alt="{!! $title !!}">
      @endif
      </a>
    </figure>
    <header class="p-6">

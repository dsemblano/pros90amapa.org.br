...
<section id="countdown">
    ...
    <div id="recent_clock" class="container">
        {!! do_shortcode('[recent_post_slider autoplay="true" autoplay_interval="100" arrows="false" design="design-1" dots="false" speed="1800" show_read_more="false" show_author="false" content_words_limit="45"]') !!}
    </div>
